...
import { categoryAdd, deleteCategory, get_category, messageClear, updateCategory } from '../../store/Reducers/categoryReducer';
  ...
  return (
    <div className='px-2 lg:px7 pt-5'>
      ...
      <div className='flex flex-wrap w-full'>
                    ...
                    <tbody>
        
                      {
                        ...
                        <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                          <img className='w-[45px] h-[45px]' src={d.image}  alt='items'/>
                        </td>
        ...
        <div className={`w-[320px] lg:w-5/12 translate-x-100 lg:relative lg:right-0 fixed ${show ? 'right-0' : '-right-[320px]' } z-[9999] top-0 transition-all duration-500 `}>
        <div className='w-full pl-5'>
          <div className='bg-[#6a5fdf] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]'> 
            ...
            <form onSubmit={addOrUpdateCategory}>
              ...
              <div className='mt-4'>
                <button disabled={loader ? true : false} className='bg-slate-500 w-full hover:shadow-blue-300/ hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
