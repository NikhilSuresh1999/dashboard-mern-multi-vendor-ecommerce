          ...
          <div className='flex flex-col gap-2 pt-6 text-[#d0d2d6]'>
            <ol className='relative border-1 border-slate-600 ml-4'>
...

               {
                ...
                {
                    m.senderId === userInfo._id ? <img className='w-full rounded-full h-full shadow-lg' src={userInfo.image.url} alt="" /> : <img className='w-full rounded-full h-full shadow-lg' src={seller} alt="" />
                } 
                </div>
            ...
            <tbody>

              {
                ...
                <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                  <Link to={`/admin/dashboard/orders/details/${d._id}`}>View</Link></td>
