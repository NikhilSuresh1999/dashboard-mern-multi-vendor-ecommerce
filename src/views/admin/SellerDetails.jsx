...
const SellerDetails = () => {
  ...
  return (
    <div className='px-2 lg:px-7 pt-5'>
       <h1 className='text-[20px] font-bold mb-3'>Sellers Details</h1>
       <div className='w-full p-4 bg-[#6a5fdf] rounded-md'>
        ...
        <div className='w-full flex flex-wrap text-[#d0d2d6]'>
          ...
          <div>
           {
            seller?.image?.url ? <img className='w-full h-[230px]' src={seller.image.url} alt=''/> : <span>Image not uploaded</span>
           }
          </div>
       ...
       <div>
        ...
        <form onSubmit={submit}>
          <div className='flex gap-4 py-3'>
            <select value={status} onChange={(e)=> setStatus(e.target.value)} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6] '
            name='' id='' required>
