    ...
    <div className='min-w-screen min-h-screen  bg-[#cdcae9] flex justify-center items-center'>
      <div className='w-400px text-[#ffffff] p-2'>
        <div className='bg-[#6f68d1] p-4 rounded-md'>
          <h1 className='text-xl mb-3 font-bold'>Welcome to Ecommerce</h1>
          <p className='text-sm mb-3 font-medium'>Please register your account</p>

          <form onSubmit={submit}>
            <div className='flex flex-col w-full gap-1 mb-3'>
              <label htmlFor='name'>Name</label>
              <input onChange={inputHandle} className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md'value={state.name} type="text" name="name" placeholder='Name' id='name' required />

            </div>

            <div className='flex flex-col w-full gap-1 mb-3'>
              <label htmlFor='email'>Email</label>
              <input onChange={inputHandle} className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md' value={state.email} type="email" name="email" placeholder='Email' id='email' required />

            </div>

            <div className='flex flex-col w-full gap-1 mb-3'>
              <label htmlFor='password'>Password</label>
              <input onChange={inputHandle} className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md'value= {state.password} type="password" name="password" placeholder='Password' id='password' required />
