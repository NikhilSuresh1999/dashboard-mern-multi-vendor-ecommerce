    ...
    <div className='px-2 lg:px-7 py-5'>
      <div className='w-full bg-[#6a5fdf] px-4 py-4 rounded-md h-[calc(100vh-140px)]'>
        <div className='flex w-full h-full relative'>
          ...
          {/* Sidebar */}
          <div className={`w-[280px] h-full absolute md:relative z-10 ${show ? 'left-0' : '-left-[336px]'} md:left-0 transition-all`}>
        ...
        customerId ? messages.map((m,i) => {
            if (m.senderId === customerId) {
                return (
                  ...
                  <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                    <div>
                      <img className='w-[38px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]' src='http://localhost:3001/images/admin.jpg' alt='demo img' />
                    </div>
                ...
                return ( 
                  ...
                  <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                    ...
                    <div>
                      <img className='w-[38px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]' src={userInfo.image.url} alt='demo img' />
                    </div>
                  </div>
                </div>
            ...
            <form onSubmit={send} className='flex gap-3'>
              <input
                ...
                className='w-full flex justify-between px-2 border border-slate-700 items-center py-[5px] focus:border-blue-500 outline-none bg-transparent text-[#d0d2d6]' 
                type='text' 
